window.JOB = {
  ...
  site: "[JOB SITE ADDRESS]",
  headline: "A written proposal for your [interior / exterior].",
  lede: "[2–4 sentences: what the space is, occupancy, sequence, warranty, specified product. No superlatives.]",
  prices: [
    { amount: "[PRICE]", label: "[Specified product]" },
    { amount: "[PRICE]", label: "[Value option — omit this object if there is only one price]" }
  ],
  ...
  scope: [
    {
      title: "[Area 1 title]",
      body: "[Surfaces, rooms, products, sheens, occupancy notes.]",
      included: ["[Prep item]", "[Coat count]", "[Other]"]
    }
  ],
  products: [
    { surface: "Walls", product: "[Product]", sheen: "[Sheen]", why: "[One honest reason]" }
  ],
  included: [
  ...
  excluded: [
    ...
    "Cabinet refinishing (quote separately)",
